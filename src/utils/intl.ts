...
export const commonMessages = defineMessages({
  ...
  successDeleted: {
    id: "9VHDsp",
    defaultMessage: "success Deleted"
  },
  failedAssigned: {
    id: "ShGXWt",
    defaultMessage: "failed Assigned"
  },
  failedDeleted: {
    id: "/QWF4l",
    defaultMessage: "failed Deleted"
  },
  catalog: {
    id: "GOdq5V",
  ...
  codeISCheck: {
    id: "BWGjod",
    defaultMessage: "This is a trusted device, do not ask again."
  },
  endDate: {
    id: "T4GOiX",
  ...
  destinationDate: {
    id: "yszcaR",
    defaultMessage: "Destination Date"
  },
  startHour: {
    id: "tWbE34",
...
export const sectionNames = defineMessages({
  ...
  shifts: {
    ...
    description: "app extensions Shifts"
  },
  attributes: {
    id: "l2oVCF",
    defaultMessage: "Attributes",
  ...
  lists: {
    ...
    description: "lists section name"
  },
  permissionGroups: {
    id: "DNTxWr",
  ...
  campaigns: {
    ...
    description: "Campaigns section name"
  }
});
export const sectionNamesListmonk = defineMessages({
  dashboard: {
    id: "lQ7WXC",
    defaultMessage: "Dashboard",
  ...
  lists: {
    id: "XMrEuy",
    defaultMessage: "Lists",
    description: "list extensions subsection"
  },
  allList: {
    id: "PLVBtW",
    defaultMessage: "All List",
    description: "all list extensions subsection"
  },
  forms: {
    id: "IiPd1M",
    defaultMessage: "Forms",
    description: "forms extensions subsection"
  },
  allSubscribers: {
    id: "j9TYhW",
    defaultMessage: "All Subscribers",
    description: "all subscribers section name"
  },
  import: {
    id: "hi4DCI",
    defaultMessage: "Import",
    description: "import section name"
  },
  bounces: {
    id: "Qps7z7",
    defaultMessage: "Bounces",
    description: "Bounces section name"
  },
  subscribers: {
    id: "02sfh8",
    defaultMessage: "Subscribers",
    description: "subscribers section name"
  },
  campaigns: {
    id: "LhCoqz",
    defaultMessage: "Campaigns",
  ...
  allCampaigns: {
    ...
    description: "all campaigns section name"
  },
  CreateNew: {
    id: "vMLsr9",
    defaultMessage: "Create New",
    description: "create new section name"
  },
  Media: {
    id: "cRve+9",
  ...
  templates: {
    ...
    description: "Templates section name"
  },
  anlytices: {
    id: "1NbW1m",
    defaultMessage: "Anlytices",
    description: "Anlytices sction name"
  },
  siteSettings: {
    id: "DAWxNv",
